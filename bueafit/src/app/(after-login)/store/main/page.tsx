...
export default function Page() {
    ...
    const borderColors = ["border-blue-400", "border-green-400", "border-pink-400"]; // 예약 표기 시 1/3 컬러 돌아가며 주입
    ...
    const fetchTreatments = async () => {
        try {
            ...
            if(res.status === 200) {
                const filteredItems = data.items.filter((item) => item.reserved_at.slice(0,10) === todayUTC);
